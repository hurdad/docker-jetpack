...
⁴ `libarrow.so` 19 MB; `libarrow_compute.so` 15 MB; `libarrow_acero.so` 2.2 MB; `libarrow_dataset.so` 2.7 MB; `libarrow_cuda.so` 279 KB.
⁵ `libarrow.a` 42 MB; `libarrow_compute.a` 26 MB; `libarrow_dataset.a` 5.9 MB; `libarrow_acero.a` 5.3 MB; `libarrow_cuda.a` 528 KB.
